...
4. Recomendacion híbrida (filtrado_híbrido.py)
...
- Con los datasets adjuntos puedes ejecutar directamente el filtrado híbrido; Asi los otros tres pasos anteriores al filtrado son opcionales y se 
incluyen solo para fines evaluativos o para ajustar parámetros si es necesario.
