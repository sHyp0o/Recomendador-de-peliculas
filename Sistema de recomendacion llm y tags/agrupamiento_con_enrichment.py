...
with open(SCRIPT_DIR / "tags_puntuados_peliculas.json", "r", encoding="utf-8") as f:
    data = json.load(f)
...
csv_filename = "datos_agrupamiento_enrichment.csv"
...
axes[0].set_title('Prediction Strength: Tags con enrichment')
...
axes[1].legend(*scatter.legend_elements(), title="Clustering: Tags con enrichment")
